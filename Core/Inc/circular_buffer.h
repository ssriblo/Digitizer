...
//TODO: int circular_buf_get_range(circular_buf_t cbuf, uint16_t *data, size_t len);
//TODO: int circular_buf_put_range(circular_buf_t cbuf, uint16_t * data, size_t len);
